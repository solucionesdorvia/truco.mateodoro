...
const weeklyPrizes = [
  { position: 1, label: '1° Puesto', amount: 1000000 },
  { position: 2, label: '2° Puesto', amount: 500000 },
  { position: 3, label: '3° Puesto', amount: 150000 },
]
...
export default function RankingsPage() {
  ...
  const renderLeaderboard = (players: PlayerRanking[]) => {
    if (players.length === 0) {
      return (
        ...
        <div className="bg-gradient-to-r from-oro/20 via-oro/10 to-oro/20 p-4 sm:p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 max-w-2xl mx-auto">
            <div className="col-span-2 md:col-span-1 text-center p-3 sm:p-4 rounded-club bg-oro/10 border-2 border-oro/40">
              <div className="flex items-center justify-center gap-2 md:flex-col md:gap-0">
                ...
                <div className="text-left md:text-center">
                  <p className="text-xs text-naipe-600 mb-0.5 sm:mb-1">{weeklyPrizes[0].label}</p>
                  <p className="text-xl sm:text-2xl font-bold text-oro">${weeklyPrizes[0].amount.toLocaleString('es-AR')}</p>
                </div>
              </div>
            </div>
            <div className="text-center p-3 sm:p-4 rounded-club bg-naipe-600/10 border border-naipe-600/30">
              ...
              <p className="text-[10px] sm:text-xs text-naipe-600 mb-0.5 sm:mb-1">{weeklyPrizes[1].label}</p>
              <p className="text-lg sm:text-2xl font-bold text-naipe-500">${weeklyPrizes[1].amount.toLocaleString('es-AR')}</p>
            </div>
            <div className="text-center p-3 sm:p-4 rounded-club bg-oro-muted/10 border border-oro-muted/30">
              <div className="text-xl sm:text-2xl mb-0.5 sm:mb-1">🥉</div>
              <p className="text-[10px] sm:text-xs text-naipe-600 mb-0.5 sm:mb-1">{weeklyPrizes[2].label}</p>
              <p className="text-lg sm:text-2xl font-bold text-oro-muted">${weeklyPrizes[2].amount.toLocaleString('es-AR')}</p>
            </div>
          </div>
        </div>
      </Card>
